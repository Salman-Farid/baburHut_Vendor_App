...
class _UploadProductState extends State<UploadProduct> {
  ...
  Future _selectPhoto() async {
    ...
    setState(() {
      ...
      currentImage = 0; // Reset currentImage to 0 whenever new images are selected
    });
  }
              ...
              Stack(
                children: [
                  CircleAvatar(
                    ...
                    child: Center(
                      child: productImages == null || productImages!.isEmpty
                          ? Image.asset(
                  ...
                  productImages == null || productImages!.isEmpty
                    ...
                    child: GestureDetector(
                      onTap: () => setState(() {
                        productImages = [];
                        currentImage = 0; // Reset currentImage when deleting images
                      }),
                      child: CircleAvatar(
                        backgroundColor: litePrimary,
                        child: const Icon(
